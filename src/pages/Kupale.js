        ...
        <div>
            ...
            <Timeline lineColor={'#ddd'}>
                ...
                >
                    ...
                    <p style={{ textAlign: 'justify' }}>
                    {t("Kupale.date2-description")}
                    </p>
                </TimelineItem>
                <TimelineItem
                    key="004"
                    dateText={t("Kupale.date3")}
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm">
                        <img alt={t("Kupale.name")} src={imageBook1} id="imgWriterDay" class="img-fluid"></img>
                    </div>
                    <div class="col-sm">
                        <img alt={t("Kupale.name")} src={imageBook2} id="imgWriterDay" class="img-fluid"></img>
                    </div>
                </div>
